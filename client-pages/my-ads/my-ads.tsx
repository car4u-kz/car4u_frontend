...
const initialData: AdFormData = {
  ...
  intervalSeconds: "",
  timingRepublishingEnabled: false,
  timingRepublishingIntervalHours: "",
...
const mapAdToFormData = (ad: OurAdItem): AdFormData => ({
  ...
  timingRepublishingEnabled: ad.timingRepublishingEnabled ?? false,
  timingRepublishingIntervalHours: ad.timingRepublishingIntervalHours ?? "",
